...
const Page = ({ params }: { params: { slug: string[] } }) => {
  interface Listing {
    ...
    amenities: string[];
    features: any; //
    reviewRatingCount: Record<string, string>;
  ...
  // const googlemapsURL = `https://www.google.com/maps/embed/v1/place?key=AIzaSyAGVJfZMAKYfZ71nzL_v5i3LjTTWnCYwTY&q=${listings?.latitude},${listings?.longitude}`;
      ...
      <div className="listingSection__wrap !space-y-6">
        ...
        <div className="flex items-center space-x-4">
          ...
          <span>
            ...
            <span className="ml-1"> {`${listings?.address?.city}`}</span>
          </span>
        </div>
        ...
        <div>
          {listings && listings.amenities && (
            <ButtonSecondary onClick={openModalAmenities}>
              ...
              View more {listings?.amenities?.length - 12} amenities
            </ButtonSecondary>
          )}
        </div>
      ...
      <div className="listingSection__wrap">
        ...
        <div className="block text-neutral-500 dark:text-neutral-400 space-y-2.5">
          <div className="flex items-center space-x-3">
            ...
            <span>
              Created on{" "}
              {new Date(listings?.createdOn as string).toLocaleDateString(
                "en-US",
                {
                  month: "long",
                  day: "numeric",
          ...
          <div className="flex items-center space-x-3">
            ...
            <span>
              Listed on{" "}
              {new Date(listings?.listedOn as string).toLocaleDateString(
                "en-US",
                {
                  month: "long",
                  day: "numeric",
    ...
    return (
      <div className="listingSection__wrap">
        ...
        <div>
          ...
          <span className="block mt-2 text-neutral-500 dark:text-neutral-400">
            {listings?.address?.address_string}
          </span>
        </div>
        ...
        {loading ? (
          ...
          <>
            ...
            <div className="w-full lg:w-3/5 xl:w-2/3 space-y-8 lg:space-y-10 lg:pr-10">
              {renderSection1()}
              {renderSection2()}
              {listings && listings?.amenities && renderSection3()}
              {renderSection4()}
              <SectionDateRange />
              {/* {renderSection5()} */}
              {/* {renderSection6()} */}
