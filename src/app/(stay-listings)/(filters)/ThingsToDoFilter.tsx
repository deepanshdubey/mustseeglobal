                    ...
                    <div className="px-10 divide-y divide-neutral-200 dark:divide-neutral-800">
                      <div className="py-7">
                        ...
                        <div className="mt-6 relative ">
                          ...
                          {/* {renderMoreFilterItem(moreFilterAge)} */}
                          {renderMoreFilterItem(moreFilterTimeOfDay)}
                        </div>
                      </div>
                      <div className="py-7">
                        {/* <h3 className="text-xl font-medium">Facilities</h3> */}
                        <h3 className="text-xl font-medium">Season</h3>
                        <div className="mt-6 relative ">
                          {/* {renderMoreFilterItem(moreFilter2)} */}
                          {renderMoreFilterItem(moreFilterSeason)}
                        </div>
                      </div>
                      {/* <div className="py-7">
